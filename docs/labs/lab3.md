...
description: Изучение библиотеки libqi для программирования робота Nao на языке Python
---
...
**Задание 1:** Робот должен пройтись прямо и одновременно произнести
какую-нибудь фразу, а после выполнения обоих действий назвать температуру в
голове и сесть.
**Задание 2:** Робот должен произносить `left hand` или `right
